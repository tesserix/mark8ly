...
function PageButton({
  ...
  // Editorial pagination: the current page is a serif tabular number
  // with a moss underline — no solid pill. Prev/next chevrons stay as
  // small hairline-bordered squares so they read as controls, not
  // decoration.
  const base =
