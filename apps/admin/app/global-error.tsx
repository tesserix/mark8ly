  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Error &middot; Mark8ly Admin</title>
        <style>{`
        ...
        <div className="container">
          <main className="main">
            <div className="content">
              ...
              <div className="rule" />
              <h1 className="heading">Application error</h1>
              <p className="desc">
                A critical error prevented the page from loading. This has been
                logged automatically. Please try refreshing.
              </p>
              {error.digest && (
          ...
          <footer className="footer">
            <p className="footer-text">mark8ly admin</p>
          </footer>
        </div>
      </body>
    </html>
