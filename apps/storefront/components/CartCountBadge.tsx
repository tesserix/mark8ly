...
export function CartCountBadge() {
  ...
  return (
    <span
      ...
      className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-[color:var(--storefront-accent,var(--ink-900))] px-1.5 text-[11px] font-semibold leading-none text-[color:var(--storefront-on-accent,var(--paper-200))]"
    >
      {count > 99 ? "99+" : count}
    </span>
  );
