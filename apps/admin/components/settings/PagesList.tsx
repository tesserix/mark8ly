      ...
      <div className="flex items-center justify-between">
        ...
        {canManage ? (
          <button
            ...
            onClick={handleAdd}
            disabled={pending}
            className="inline-flex items-center justify-center rounded-md border border-border bg-background-elevated/70 px-3 py-1.5 text-xs font-medium text-foreground hover:bg-background-elevated disabled:cursor-not-allowed disabled:opacity-50"
          >
