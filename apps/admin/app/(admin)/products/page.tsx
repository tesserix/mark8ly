...
export default async function ProductsPage({
  ...
  const { currentStore, role, userId, tenantId, stores } = session;
  ...
  const description =
    "Every item you sell across this store — inventory, pricing, variants, and visibility.";

  if (!currentStore) {
    return (
      <AdminPage eyebrow="Catalogue" title="Products" description={description}>
