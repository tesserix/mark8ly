// Package httpserver provides Gin setup with the conventions used across services.
package httpserver
...
// Run starts the server on the given port and shuts it down on context cancel.
