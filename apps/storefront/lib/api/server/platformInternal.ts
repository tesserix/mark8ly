...
//
// Mirror of apps/admin/lib/api/server/platformInternal.ts; kept as a
// per-app copy so the storefront's server bundle doesn't pull in the
// admin app's module graph.
