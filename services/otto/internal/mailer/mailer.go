...
type Mailer interface {
	SendOTP(ctx context.Context, to, recipientName, code, storeName string) error
}
...
func (m *LogMailer) SendOTP(_ context.Context, to, recipientName, code, storeName string) error {
	if m.Logger == nil {
