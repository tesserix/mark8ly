...
export function HelpArticleRenderer({ content }: HelpArticleRendererProps) {
  ...
  return (
    <div
      className="prose prose-sm max-w-none text-foreground prose-headings:font-[family-name:var(--font-source-serif),'Source_Serif_4',serif] prose-headings:font-medium prose-headings:text-foreground prose-h2:mt-10 prose-h2:text-2xl prose-h3:text-lg prose-p:leading-7 prose-p:text-foreground-secondary prose-a:text-[color:var(--moss-700)] prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-li:text-foreground-secondary prose-code:rounded prose-code:bg-paper-100 prose-code:px-1 prose-code:py-0.5 prose-code:text-foreground"
