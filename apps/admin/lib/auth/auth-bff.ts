...
// ---------------------------------------------------------------------------
// Google sign-in through Zitadel's IDP-intent flow (#524 phase 3c-2), the
 ...
 * workspace_tenant} to POST /auth/zitadel/idp/finish — the merchant
 * counterpart of the storefront's finishCustomerIDPIntent, except this
 * endpoint runs the full merchant gauntlet (FGA membership, the MFA gate,
 * deviceguard, the email-OTP step-up) and mints `m8_session` on success,
 * exactly like zitadelLogin/zitadelTotp above. The 2xx body is handed to
 * parseLoginResponse rather than parsed here, so this function's outcome
