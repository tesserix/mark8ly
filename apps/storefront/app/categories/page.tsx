    ...
    <div className="min-h-screen bg-[color:var(--paper-200)]">
      ...
      >
        <header className="max-w-2xl">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-source-serif),'Source_Serif_4',serif] text-4xl font-medium text-[color:var(--ink-900)] sm:text-5xl">
            Categories
          </h1>
        ...
        {categories.length === 0 ? (
          <div className="mt-12 border-t border-[color:var(--ink-900)]/10 pt-12">
            <p className="max-w-xl text-base leading-7 text-[color:var(--ink-900)] opacity-60">
              No categories yet — the catalog is still being put together.
            </p>
            <Link
              href="/"
              className="mt-4 inline-block text-sm font-semibold text-[color:var(--moss-700)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--moss-700)]"
            >
              Back home →
            </Link>
          </div>
            ...
            {categories.map((c) => (
              <li key={c.slug}>
                <Link
                  ...
                  className="group block border-t border-[color:var(--ink-900)]/10 pt-4 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--moss-700)]"
                >
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[color:var(--ink-900)] opacity-55">
                    Collection
                  </p>
                  <h2 className="mt-2 font-[family-name:var(--font-source-serif),'Source_Serif_4',serif] text-2xl text-[color:var(--ink-900)] transition-opacity group-hover:opacity-80">
                    {c.name}
                  </h2>
                </Link>
              </li>
