    ...
    <div className="space-y-6">
      ...
      <div className="rounded-[6px] bg-white px-6 py-5">
        ...
        <div className="mt-2 flex items-center gap-3">
          <code className="rounded-[4px] bg-[color:var(--paper-200)] px-3 py-1.5 font-mono text-sm font-medium text-[color:var(--ink-900)]">
      ...
      {program.tiers.length > 0 && (
        <div className="rounded-[6px] bg-white px-6 py-5">
          <h3 className="mb-3 text-sm font-semibold uppercase tracking-[0.12em] text-[color:var(--ink-900)]/50">
            Tiers
          </h3>
