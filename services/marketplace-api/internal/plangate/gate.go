...
// tenant-scoped routes (e.g. POST /admin/break-glass/login, which peeks
// tenant_id from the request body — see admin.RequireBreakGlassFeature) don't
// need a storeId in the URL. Falls back to PlanTrial on any error
// (fail-closed).
