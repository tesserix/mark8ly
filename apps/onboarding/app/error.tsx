        ...
        <div className="w-full max-w-xl space-y-6 motion-safe:animate-[fadeInUp_0.4s_ease-out]">
          ...
          <div className="pt-2">
            <button
              type="button"
              onClick={reset}
              className="inline-flex h-11 items-center rounded-[var(--radius)] bg-[color:var(--ink-900)] px-5 text-sm font-medium text-[color:var(--paper-50,#fff)] transition-opacity duration-150 hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--moss-700)]"
            >
              Try again
            </button>
          </div>
