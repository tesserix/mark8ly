...
INSERT INTO products (id, tenant_id, store_id, handle, title, description, status, tags, seo_title, seo_description, primary_category_id, published_at, created_at, updated_at)
VALUES ('a28defe3-9bf0-4273-9247-6f57a5e5a5ab'::uuid, '8c302556-b647-4824-8ce4-73f547ca456e'::uuid, '8b69eea9-2537-4d36-9d99-bafcbad02dbc'::uuid, 'palm-beach-linen-robe', 'Palm Beach Linen Robe', 'An open-front linen robe to throw over swimwear. V-neck, three-quarter sleeves, and an exaggerated tie at the waist that you can knot once or wrap twice. Cuts a clean line from the towel to the bar.', 'active', ARRAY['linen', 'robe', 'cover-up', 'beach']::text[], 'Palm Beach Linen Robe — The Bondi Store', 'Open-front linen beach robe with tie waist. Two sizes: XS-S, M-L.', 'bdd640fb-0667-4ad1-9c80-317fa3b1799d'::uuid, NOW(), NOW(), NOW());
...
-- ── Pacific Cotton Tank ──────────────────────────────────────
INSERT INTO products (id, tenant_id, store_id, handle, title, description, status, tags, seo_title, seo_description, primary_category_id, published_at, created_at, updated_at)
VALUES ('366eb16f-508e-4ad7-b7c9-3acfe059a0ee'::uuid, '8c302556-b647-4824-8ce4-73f547ca456e'::uuid, '8b69eea9-2537-4d36-9d99-bafcbad02dbc'::uuid, 'pacific-cotton-tank', 'Pacific Cotton Tank', 'Heavyweight ribbed cotton tank with a relaxed armhole and a trim band at the neckline. Designed to wear loose and untucked on the warmest days. Garment-dyed for a soft, slightly faded hand right out of the box.', 'active', ARRAY['cotton', 'tank', 'summer']::text[], 'Pacific Cotton Tank — The Bondi Store', 'Ribbed cotton tank, heavyweight, garment-dyed for a soft hand.', '23b8c1e9-3924-46de-beb1-3b9046685257'::uuid, NOW(), NOW(), NOW());
...
INSERT INTO products (id, tenant_id, store_id, handle, title, description, status, tags, seo_title, seo_description, primary_category_id, published_at, created_at, updated_at)
VALUES ('405cacec-8774-49a9-b7d2-1e02ff01cf99'::uuid, '8c302556-b647-4824-8ce4-73f547ca456e'::uuid, '8b69eea9-2537-4d36-9d99-bafcbad02dbc'::uuid, 'sandstone-ceramic-mug', 'Sandstone Ceramic Mug', 'Hand-thrown stoneware mug in unglazed sandstone with a soft-glaze interior. 350ml. No two are identical — small variations in form and glaze pooling are part of the work, not a flaw. Made by a single ceramicist in Berry, NSW.', 'active', ARRAY['ceramic', 'mug', 'home']::text[], 'Sandstone Ceramic Mug — The Bondi Store', 'Hand-thrown 350ml stoneware mug, unglazed sandstone, made in Berry NSW.', 'bd9c66b3-ad3c-4d6d-9a3d-1fa7bc8960a9'::uuid, NOW(), NOW(), NOW());
