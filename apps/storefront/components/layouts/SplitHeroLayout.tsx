...
import { defaultSplitHeroContent } from "./SplitHeroLayout.defaults";
import { resolveLayoutContent, type LayoutProps } from "./shared";

export function SplitHeroLayout({ store, theme, content }: LayoutProps) {
  const resolved = resolveLayoutContent(content, defaultSplitHeroContent(store));
  return (
