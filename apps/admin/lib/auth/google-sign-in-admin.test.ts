...
describe("buildAdminGoogleReturnUrl", () => {
  it("builds an https URL on the given host at /auth/idp/finish", () => {
    const url = buildAdminGoogleReturnUrl("demo-store-admin.mark8ly.com", "V2_abc");
    expect(url).toBe(
      "https://demo-store-admin.mark8ly.com/auth/idp/finish?auth_request_id=V2_abc",
    );
  });
