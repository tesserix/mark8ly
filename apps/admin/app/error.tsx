  ...
  return (
    <div className="grid min-h-[70vh] grid-rows-[1fr_auto]">
      <main className="flex items-end px-6 pb-16 pt-24 sm:px-12 lg:px-24">
        <div className="w-full max-w-2xl space-y-6 motion-safe:animate-[fadeInUp_0.4s_ease-out]">
          ...
          <p className="max-w-md text-[15px] leading-relaxed text-foreground-secondary">
            We hit a problem loading this page. This has been logged
            automatically&thinsp;&mdash;&thinsp;you don&rsquo;t need to report
            it. Try again, or come back shortly.
          </p>
          {error.digest && (
