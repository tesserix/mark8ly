 ...
 * The form collects a password and hands it to platform-api, which
 * provisions the Zitadel user, the admin project grant and the FGA
 * tuples, then sends the invitee into the normal Zitadel login flow.
 * See issue #679.
 */
