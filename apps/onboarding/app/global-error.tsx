  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Something went wrong &middot; mark8ly</title>
        <style>{`
        ...
        <div className="wrap">
          <main className="main">
            <div className="content">
              ...
              <div className="rule" />
              <h1 className="heading">Unexpected error</h1>
              <p className="desc">
                We hit a problem during onboarding. Your progress is saved&thinsp;&mdash;&thinsp;please
          ...
          <footer className="footer">
            <p className="footer-text">mark8ly</p>
          </footer>
        </div>
      </body>
    </html>
